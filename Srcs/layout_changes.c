...
/*   Updated: 2023/09/08 18:57:49 by hnogared         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	goto_layout2(dispopts **disp_options, bool loading)
{
	...
	strncpy((*disp_options)->bomb_output, "installed modules\n\n"
		" * DISPLAY CONTROLLER (UNO_R3)\t- [LS3249] - Communication protocol : Wire l2C\n"
		" * TIME_CONTROL_UNIT (ELEGO_R3)\t- [CR57a5] - ACCESS LOCKED\n"
		" * DATA_STORAGE (ESP32_V4)\t- [PK84u9] - Communication protocol : Serial UART\n"
		" * MOTOR_ACTUATOR (Servo motor)\t- [RM3oRF] - ACCESS RESTRICTED\n", BIG_BUFFER - 1);
	(*disp_options)->bomb_output[BIG_BUFFER - 2] = 0;
