...
{
	safer_strncpy(data_p->dispopts_s.cmd_output,
		" * Bienvenue sur l'aide au desamorcage.\n"
		" *\n"
...
void	goto_layout_1(t_data *data_p)
{
	...
	safer_strncpy(data_p->dispopts_s.cmd_output,
		" * Bienvenue sur l'interface de desamorcage.\n"
...
void	goto_layout_2(t_data *data_p, bool loading)
{
	...
	safer_strncpy(data_p->dispopts_s.cmd_output, " > Connecte a la bombe\n\n"
		" # [1] Quitter le programme (ou tapez 'exit')\n"
...
void	goto_layout_3(t_data *data_p, bool loading)
{
	...
	safer_strncpy(data_p->dispopts_s.bomb_output,
		...
		BOMBOUT_BUFFER, 512);
	safer_strncpy(data_p->dispopts_s.cmd_output, " > Scan effectue\n"
...
{
	safer_strncpy(data_p->dispopts_s.cmd_output, " > Attaque reussie\n"
...
{
	safer_strncpy(data_p->dispopts_s.cmd_output,
		" > Firewall desactive, acces a la memoire ouvert\n"
...
{
	safer_strncpy(data_p->dispopts_s.cmd_output, " > Overflow de la memoire\n"
		" # [1] Quitter le programme (ou tapez 'exit')\n"
		" # [2] Deconnection de la bombe\n"
...
void	goto_layout_password(t_data *data_p, bool mode)
{
	...
	safer_strncpy(data_p->dispopts_s.cmd_output,
		" > Affichage de la memoire corrompue\n"
